...
def run_simulation(num_robots, collision_protocol, tracked_robot=-1, show_graph=False, csv_path=""):  
...
run_simulation(10, RobotSwarmingSimulator.COLLISION_PROTOCOL.FIND_NEXT_AVAILABLE, csv_path="A61_R10_FN.csv")